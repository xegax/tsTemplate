...
export function createConnection(connectionUri: string): IConnection;
export function createConnection(config: IConnectionConfig): IConnection;
export function createPool(config: IPoolConfig): IPool;
export function createPoolCluster(config?: IPoolClusterConfig): IPoolCluster;
